...
Focusing on their 6-layer, sequence length 128, W = {1,2,4,8,12,16} model configuration as described in Section 3.2 of the paper. Experiments are conducted on the WikiText-2 dataset.
